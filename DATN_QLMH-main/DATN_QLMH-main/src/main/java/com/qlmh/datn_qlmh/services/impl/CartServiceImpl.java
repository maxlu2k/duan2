...
public class CartServiceImpl implements ICartService {
    ...
    @Autowired
    public CartServiceImpl(CartRepo cartRepo, DetailCartRepo detailCartRepo, ProductRepo productRepo, AccountRepo accountRepo, ModelMapper modelMapper, ImageRepo imageRepo, VoucherRepo voucherRepo, DiscountRepo discountRepo) {
    ...
    public DetailCartResponse addToCart(CartRequest request) {
        ...
        ProductEntity productEntity = this.productRepo.findByIdAndStatus(productId, 1);
...
//        Page<CartEntity> cartEntityPage = cartRepo.findAll(PageRequest.of(items.getPageNumber(), items.getPageSize()));
